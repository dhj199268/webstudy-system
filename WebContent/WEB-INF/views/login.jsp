...
<body class="login">
	...
	<div class="content">
		...
		<form class="login-form" action="rest/user/login" method="post">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-user"></i> <input name="username" id="username"
						size="25" value="starzou" class="form-control placeholder-no-fix"
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-lock"></i> <input name="password" id="password"
						size="25" value="123456" class="form-control placeholder-no-fix"
			...
			<div class="forget-password">
				<h4>忘记密码 ?</h4>
				<p>
					点击 <a href="javascript:;" id="forget-password">这里</a> 重置您的密码.
				</p>
			</div>
			...
			<div class="form-group">
				...
				<div class="controls">
					<div class="input-icon">
						<i class="fa fa-check"></i> <input
							class="form-control placeholder-no-fix" type="password"
							autocomplete="off" placeholder="再次输入密码" name="rpassword" />
					</div>
				</div>
			</div>
			<div class="form-group">
				<label> <input type="checkbox" name="tnc" /> 我同意 <a href="#">服务条款</a>
					和 <a href="#">隐私政策</a>
				</label>
	...
	<!-- END LOGIN -->
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">2014 &copy; Eliteams - Quick4j</div>
	<!-- END COPYRIGHT -->
